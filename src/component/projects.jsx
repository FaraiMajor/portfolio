            ...
            <section class="projectSection" >
                ...
                <div className="projectsContainer sectionContainer">
                    ...
                    <article class="workBox">
                        ...
                        <div class="describeContainer">
                            <h3>Note App</h3>
                            <h4>Technologies Used: <span class="techStack">React</span>,<span class="techStack">CSS</span></h4>
                            <ul>
                            ...
                            <div class="projectLinks">
                                <a href="https://faraimajor.github.io/note-app/" class="liveLink" target="_blank" rel="noopener noreferrer">Live</a>
                                <a href="https://github.com/FaraiMajor/note-app" class="repoLink" target="_blank" rel="noopener noreferrer">Repo</a>
                            </div>
                        </div>
                    </article>
                    <article class="workBox">
